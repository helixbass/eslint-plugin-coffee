...
(function() {
  ...
  ruleTester.run('no-webpack-loader-syntax', rule, {
    valid: ['import _ from "lodash"', 'import find from "lodash.find"', 'import foo from "./foo.css"', 'import data from "@scope/my-package/data.json"', '_ = require("lodash")', 'find = require("lodash.find")', 'foo = require("./foo")', 'foo = require("../foo")', 'foo = require("foo")', 'foo = require("./")', 'foo = require("@scope/foo")'],
    invalid: [
      {
