...
(function() {
  /* eslint-env jest */
  var RuleTester, alwaysValid, configs, errorMessage, expectedError, neverValid, parserOptionsMapper, path, recommendedOptions, rule, ruleName, ruleOptionsMapperFactory, ruleTester, strictOptions;
  ...
  rule = require('eslint-plugin-jsx-a11y/lib/rules/no-noninteractive-element-interactions');
  ...
  errorMessage = 'Non-interactive elements should not be assigned mouse or keyboard event listeners.';
