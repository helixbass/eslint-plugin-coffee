...
(function() {
   ...
   */
  'use strict';
  var CREATE_ELEMENT_ERROR, JSX_ERROR, RuleTester, path, rule, ruleTester;
  ...
  JSX_ERROR = 'Do not pass children as props. Instead, nest children between the opening and closing tags.';

  CREATE_ELEMENT_ERROR = 'Do not pass children as props. Instead, pass them as additional arguments to React.createElement.';
