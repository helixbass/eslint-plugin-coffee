...
(function() {
   ...
   */
  'use strict';
  var RuleTester, blockError, lineError, rule, ruleTester;
  ...
  ruleTester.run('no-inline-comments', rule, {
    valid: ['# A valid comment before code\na = 1', 'a = 2\n# A valid comment after code', '# A solitary comment', 'a = 1 # eslint-disable-line some-rule', 'a = 1 ### eslint-disable-line some-rule ###'],
    invalid: [
      {
