...
(function() {
  ...
  ruleTester.run('sort-keys', rule, {
    valid: [
      ...
      {
        // nested
        code: 'obj = {a:1, b:{x:1, y:1}, c:1}',
        options: []
      },
      {
        // asc
        code: 'obj = {_:2, a:1, b:3} # asc',
        options: ['asc']
      },
      {
        code: 'obj = {a:1, b:3, c:2}',
      ...
      {
        code: 'obj = {c:2, b_:1, C:3}',
        options: ['desc']
      },
      {
        code: 'obj = {a:4, _:2, A:3, $:1}',
        options: ['desc']
      },
      {
    ...
    invalid: [
      ...
      },
      {
        ...
        errors: ["Expected object keys to be in ascending order. 'x' should be before 'y'.",
      ...
      },
      {
        code: 'obj = {$:1, _:2, A:3, a:4}',
        options: ['desc'],
        errors: ["Expected object keys to be in descending order. '_' should be before '$'.",
      "Expected object keys to be in descending order. 'a' should be before 'A'."]
      },
      {
        code: "obj = {1:1, 2:4, A:3, '11':2}",
        options: ['desc'],
        errors: ["Expected object keys to be in descending order. '2' should be before '1'.",
      "Expected object keys to be in descending order. 'A' should be before '2'."]
      },
      {
        code: "obj = {'#':1, À:3, 'Z':2, è:4}",
        options: ['desc'],
        errors: ["Expected object keys to be in descending order. 'À' should be before '#'.",
      ...
      },
      {
        ...
        errors: ["Expected object keys to be in insensitive descending order. '_' should be before '$'.",
      ...
      },
      {
        ...
        errors: ["Expected object keys to be in insensitive descending order. '2' should be before '1'.",
      ...
      },
      {
        ...
        errors: ["Expected object keys to be in insensitive descending order. 'À' should be before '#'.",
      ...
      },
      {
        ...
        errors: ["Expected object keys to be in natural descending order. '_' should be before '$'.",
      ...
      },
      {
        ...
        errors: ["Expected object keys to be in natural descending order. '2' should be before '1'.",
      ...
      },
      {
        ...
        errors: ["Expected object keys to be in natural descending order. 'À' should be before '#'.",
      ...
      },
      {
        ...
        errors: ["Expected object keys to be in natural insensitive descending order. '_' should be before '$'.",
      ...
      },
      {
        ...
        errors: ["Expected object keys to be in natural insensitive descending order. '2' should be before '1'.",
      ...
      },
      {
        ...
        errors: ["Expected object keys to be in natural insensitive descending order. 'À' should be before '#'.",
