  ...
  ruleTester.run('no-unknown-property', rule, {
    ...
    invalid: [
      ...
      },
      {
        ...
        errors: [
          {
            message: "Unknown property 'for' found, use 'htmlFor' instead"
          }
        ]
      },
      {
        ...
        errors: [
          {
            message: "Unknown property 'accept-charset' found, use 'acceptCharset' instead"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        errors: [
          {
            message: "Invalid property 'crossOrigin' found on tag 'div', but it is only allowed on: script, img, video, audio, link"
          }
        ]
      }
    ]
