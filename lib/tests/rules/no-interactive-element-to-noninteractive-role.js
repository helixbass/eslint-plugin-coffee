...
(function() {
  ...
  rule = require('eslint-plugin-jsx-a11y/lib/rules/no-interactive-element-to-noninteractive-role');
  ...
  errorMessage = 'Interactive elements should not be assigned non-interactive roles.';
