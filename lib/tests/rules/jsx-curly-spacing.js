...
(function() {
  ...
  ruleTester.run('jsx-curly-spacing', rule, {
    valid: [
      ...
      {
        code: '<App foo={bar: yes, baz: yes}>{bar: yes, baz: yes}</App>'
      },
      {
        code: '<App foo={{ bar: true, baz: true }}>{ { bar: true, baz: true } }</App>'
      },
    ...
    invalid: [
      ...
      {
        code: '<App foo={ bar: yes, baz: yes }>{ bar: yes, baz: yes }</App>',
        output: '<App foo={bar: yes, baz: yes}>{ bar: yes, baz: yes }</App>',
        errors: [
          {
            message: "There should be no space after '{'"
          },
      ...
      {
        code: ['<div className={ if this.state.renderInfo then "infoPanel col-xs-12" else "unToggled col-xs-12" } />'].join('\n'),
        output: ['<div className={if this.state.renderInfo then "infoPanel col-xs-12" else "unToggled col-xs-12"} />'].join('\n'),
        options: [
          'never',
          {
            allowMultiline: true
