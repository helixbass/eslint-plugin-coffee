...
(function() {
  /* eslint-env jest */
  var RuleTester, alwaysValid, configs, errorMessage, expectedError, neverValid, parserOptionsMapper, path, recommendedOptions, rule, ruleName, ruleOptionsMapperFactory, ruleTester;
  ...
  rule = require('eslint-plugin-jsx-a11y/lib/rules/no-noninteractive-element-to-interactive-role');
  ...
  errorMessage = 'Non-interactive elements should not be assigned interactive roles.';
  ...
  recommendedOptions = configs.recommended.rules[ruleName][1] || {};
