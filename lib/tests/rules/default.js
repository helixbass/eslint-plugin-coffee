...
(function() {
  var CASE_SENSITIVE_FS, RuleTester, SYNTAX_CASES, path, rule, ruleTester, test;
  ...
  ruleTester.run('default', rule, {
    ...
    invalid: [
      test({
        ...
        errors: ["Parse errors in imported module './malformed.koffee': unexpected implicit function call (1:8)"]
      }),
      test({
