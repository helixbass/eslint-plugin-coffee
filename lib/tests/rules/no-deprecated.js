...
(function() {
  ...
  errorMessage = function(oldMethod, version, newMethod, refs) {
  ...
  render: ->
      ...
      {
        // Non-React
        code: `Foo = createReactClassNonReact({
  componentWillMount: ->,
    ...
    invalid: [
      {
        ...
        errors: [
          {
            message: errorMessage('React.renderComponent',
          '0.12.0',
          'React.render')
          }
        ]
      },
      {
        ...
        errors: [
          {
            message: errorMessage('Foo.renderComponent',
          '0.12.0',
          'Foo.render')
          }
        ]
      ...
      },
      {
        ...
        errors: [
          {
            message: errorMessage('this.transferPropsTo',
          '0.12.0',
          'spread operator ({...})')
          }
        ]
      },
      {
        ...
        errors: [
          {
            message: errorMessage('React.addons.TestUtils',
          '15.5.0',
          'ReactDOM.TestUtils')
          }
        ]
      },
      {
        ...
        errors: [
          {
            message: errorMessage('React.addons.classSet',
          '0.13.0',
      ...
      },
      {
        ...
        errors: [
          {
            message: errorMessage('React.render',
          '0.14.0',
          'ReactDOM.render')
          }
        ]
      },
      {
        ...
        errors: [
          {
            message: errorMessage('React.unmountComponentAtNode',
          '0.14.0',
      ...
      },
      {
        ...
        errors: [
          {
            message: errorMessage('React.findDOMNode',
          '0.14.0',
      ...
      },
      {
        ...
        errors: [
          {
            message: errorMessage('React.renderToString',
          '0.14.0',
      ...
      },
      {
        ...
        errors: [
          {
            message: errorMessage('React.renderToStaticMarkup',
          '0.14.0',
      ...
      },
      {
        ...
        errors: [
          {
            message: errorMessage('React.createClass',
          '15.5.0',
      ...
      },
      {
        ...
        errors: [
          {
            message: errorMessage('Foo.createClass',
          '15.5.0',
          'the npm module create-react-class')
          }
        ]
      },
      {
        ...
        errors: [
          {
            message: errorMessage('React.PropTypes',
          '15.5.0',
...
{createClass, PropTypes} = React`,
      ...
      },
      {
        ...
        errors: [
          {
            message: errorMessage('ReactPerf.printDOM',
          '15.0.0',
      ...
      {
        code: `import ReactPerf from 'react-addons-perf'
{printDOM} = ReactPerf`,
        // parser: 'babel-eslint'
        errors: [
          {
      ...
      },
      {
        ...
        errors: [
          {
            message: errorMessage('React.DOM',
          '15.6.0',
      ...
      {
        code: `class Bar extends React.PureComponent
  componentWillMount: ->
  componentWillReceiveProps: ->
  componentWillUpdate: ->`,
        errors: [
          {
            message: errorMessage('componentWillMount',
          '16.3.0',
          ...
          {
            message: errorMessage('componentWillReceiveProps',
          '16.3.0',
          ...
          {
            message: errorMessage('componentWillUpdate',
          '16.3.0',
  ...
  class Bar extends React.PureComponent
    ...
    componentWillUpdate: ->`,
      ...
      {
        code: `class Bar extends PureComponent
  componentWillMount: ->
  componentWillReceiveProps: ->
  componentWillUpdate: ->`,
        errors: [
