...
(function() {
  ...
  ruleTester.run('no-unsafe-negation', rule, {
    valid: ['a in b', 'a not in b', 'a of b', 'a not of b', 'a in b is false', '!(a in b)', 'not (a in b)', '!(a not in b)', '!(a of b)', '!(a not of b)', '(!a) in b', '(not a) in b', '(!a) not in b', '(!a) of b', '(!a) not of b', 'a instanceof b', 'a not instanceof b', 'a instanceof b is false', '!(a instanceof b)', 'not (a instanceof b)', '!(a not instanceof b)', '(!a) instanceof b', '(!a) not instanceof b'],
    invalid: [
      {
        code: '!a in b',
        output: '!(a in b)',
      ...
      },
      {
        ...
        errors: ["Unexpected negating the left operand of 'not instanceof' operator."]
      },
      {
