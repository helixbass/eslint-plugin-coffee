...
(function() {
  var RuleTester, getRelativeZonePath, path, rule, ruleTester, test, testFilePath;
  ...
  getRelativeZonePath = function(fixturePath) {
    return `./src/tests/fixtures/import/${fixturePath}`;
  };
  ...
  ruleTester.run('no-restricted-paths', rule, {
    ...
    invalid: [
      test({
        ...
        errors: [
          {
            message: 'Unexpected path "../server/b.coffee" imported in restricted zone.',
            line: 1,
            column: 15
          }
        ]
