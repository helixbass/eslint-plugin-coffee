...
(function() {
  var RuleTester, path, rule, ruleTester, runResolverTests, test;
  ...
  runResolverTests = function(resolver) {
    return ruleTester.run(`no-useless-path-segments (${resolver})`, rule, {
      valid: [
        ...
        test({
          code: 'import "../index"' // noUselessIndex is false by default
        }),
        test({
        ...
        test({
          ...
          options: [
            {
              noUselessIndex: true // ./bar/index.coffee exists
            }
          ]
        }),
        test({
        ...
        test({
          ...
          options: [
            {
              noUselessIndex: true // ./bar.coffee exists
            }
          ]
        }),
        test({
          ...
          options: [
            {
              noUselessIndex: true // ./malformed directory does not exist
            }
          ]
        }),
        test({
        ...
        test({
          ...
          options: [
            {
              noUselessIndex: true // ./importType.coffee does not exist
            }
          ]
        }),
        test({
      ...
      invalid: [
        ...
        test({
          ...
          errors: ['Useless path segments for "./../import/malformed.koffee", should be "../import/malformed.koffee"']
        }),
        test({
          ...
          errors: ['Useless path segments for "./../import/malformed", should be "../import/malformed"']
        }),
        test({
          code: 'require("../import/malformed.koffee")',
          options: [
          ...
          errors: ['Useless path segments for "../import/malformed.koffee", should be "./malformed.koffee"']
        }),
        test({
          code: 'require("../import/malformed")',
          options: [
          ...
          errors: ['Useless path segments for "../import/malformed", should be "./malformed"']
        }),
        test({
        ...
        test({
          ...
          errors: ['Useless path segments for "./bar/index.coffee", should be "./bar/"'] // ./bar.coffee exists
        }),
        test({
        ...
        test({
          ...
          errors: ['Useless path segments for "./importPath/", should be "./importPath"'] // ./importPath.coffee does not exist
        }),
        test({
          ...
          errors: ['Useless path segments for "./importPath/index.coffee", should be "./importPath"'] // ./importPath.coffee does not exist
        }),
        test({
          ...
          errors: ['Useless path segments for "./importType/index", should be "./importType"'] // ./importPath.coffee does not exist
        }),
        test({
          code: 'require("./index")',
          options: [
        ...
        test({
          ...
          errors: ['Useless path segments for "./importPath/index", should be "./importPath"'] // ./importPath.coffee does not exist
        }),
        test({
          code: 'import "./index"',
          options: [
