...
(function() {
  var RuleTester, path, rule, ruleTester, test, testFilePath;
  ...
  ruleTester.run('extensions', rule, {
    valid: [
      ...
      test({
        code: ['import a from "a"',
      'import packageConfig from "./package.json"'].join('\n'),
        options: [
          {
            json: 'always',
            js: 'never',
      ...
      'import barhbs from "./bar.hbs"'].join('\n'),
        options: [
          'always',
          {
            js: 'never',
...
import express from 'express'`,
      ...
      // export (#964)
      test({
        code: `export { foo } from "./foo.coffee"
bar = null
export { bar }`,
        options: ['always']
      }),
...
export { bar }`,
    ...
    invalid: [
      ...
      test({
        code: ['import a from "a/index.js"',
      'import packageConfig from "./package"'].join('\n'),
        options: [
          {
            json: 'always',
            js: 'never'
      ...
      test({
        code: ['import lib from "./bar.coffee"',
      'import component from "./bar.jsx"',
      'import data from "./bar.json"'].join('\n'),
        options: ['never'],
        // settings: 'import/resolve': extensions: ['.js', '.jsx', '.json']
        errors: [
          {
      ...
      test({
        code: ['import component from "./bar.coffee"',
      'import data from "./bar.json"'].join('\n'),
        options: [
          {
            json: 'always',
      ...
      test({
        code: ['import barjs from "./bar.coffee"',
      'import barjson from "./bar.json"',
      'import barnone from "./bar"'].join('\n'),
        options: [
          'always',
          {
            json: 'always',
      ...
      test({
        ...
        errors: [
          {
            message: 'Unexpected use of file extension "coffee" for "./fake-file.coffee"',
            line: 1,
            column: 19
          }
        ]
...
import express from 'express'`,
        errors: [
          ...
          {
            message: 'Unexpected use of file extension "coffee" for "./Component.coffee"',
            line: 3,
            column: 23
          }
        ],
