...
(function() {
  ...
  ruleTester.run('capitalized-comments', rule, {
    valid: [
      ...
      '# and this one is valid since it follows a valid one,',
      'foo()',
      '# This comment now has to be capitalized.'].join('\n'),
        options: [
          'always',
          {
            ignoreConsecutiveComments: true
      ...
      '### blockCommentIgnorePattern ###'].join('\n'),
        options: [
          'always',
          {
            line: {
    ...
    invalid: [
      ...
      '# and this one is valid since it follows a valid one,',
      'foo()',
      '# this comment is now invalid.'].join('\n'),
      ...
      '# but this one is ignored since it is consecutive.'].join('\n'),
      ...
      },
      {
        ...
        code: ['# This comment is valid since it is capitalized,',
      '# but this one is invalid even if it follows a valid one.'].join('\n'),
        output: ['# This comment is valid since it is capitalized,',
      '# But this one is invalid even if it follows a valid one.'].join('\n'),
        options: [
          'always',
