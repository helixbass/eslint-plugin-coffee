...
(function() {
   ...
   */
  'use strict';
  var ALIGNMENT_ERROR, END_NEWLINE_ERROR, EXPECTED_BLOCK_ERROR, EXPECTED_LINES_ERROR, MISSING_HASH_ERROR, MISSING_STAR_ERROR, RuleTester, START_NEWLINE_ERROR, path, rule, ruleTester;
...
# contains '###'.`,
      {
        code: `# The following line comment
# contains '###'.`,
        options: ['bare-block']
      },
      {
