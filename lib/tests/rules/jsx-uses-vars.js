...
(function() {
   ...
   */
  'use strict';
  var RuleTester, eslint, linter, path, ref, ruleNoUnusedVars, ruleTester;
  ...
  linter = (ref = ruleTester.linter) != null ? ref : eslint.linter;

  linter.defineRule('jsx-uses-vars', require('eslint-plugin-react/lib/rules/jsx-uses-vars'));

  ruleTester.run('no-unused-vars', ruleNoUnusedVars, {
    valid: [
      {
        code: `### eslint jsx-uses-vars: 1 ###
foo = ->
  App = null
...
React.render(<Button.Input unused=""/>)`,
        errors: [
          {
            message: "'Input' is assigned a value but never used."
          }
        ]
      },
      {
