...
(function() {
   ...
   */
  'use strict';
  var RuleTester, defaultErrors, path, rule, ruleTester;
  ...
  defaultErrors = [
    {
      message: 'Using target="_blank" without rel="noreferrer" is a security risk:' + ' see https://html.spec.whatwg.org/multipage/links.html#link-type-noopener'
    }
  ];
