...
(function() {
  ...
  makeSegments = function({
    ...
    var i, j, k, normalizedBegin, normalizedEnd, ref, results;
    ...
    for (i = k = 0, ref = count; (0 <= ref ? k < ref : k > ref); i = 0 <= ref ? ++k : --k) {
      results.push(create(idGenerator.next(), (function() {
        var l, ref1, ref2, results1;
        results1 = [];
        for (j = l = ref1 = normalizedBegin, ref2 = normalizedEnd; (ref1 <= ref2 ? l <= ref2 : l >= ref2); j = ref1 <= ref2 ? ++l : --l) {
          results1.push(list[j][i]);
        }
        return results1;
      })()));
    }
  ...
  mergeExtraSegments = function({count, idGenerator}, segments) {
    ...
    while (currentSegments.length > count) {
      ...
      for (i = k = 0, ref = length; (0 <= ref ? k < ref : k > ref); i = 0 <= ref ? ++k : --k) {
        merged.push(CodePathSegment.newNext(idGenerator.next(), [currentSegments[i], currentSegments[i + length]]));
      }
  ...
  ForkContext = class ForkContext {
     ...
     */
    constructor(idGenerator1, upper, count1) {
    ...
    addAll({
      ...
      return this.segmentsList.push(...source);
    }
