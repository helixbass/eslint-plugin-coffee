...
(function() {
  ...
  module.exports = {
    ...
    create: function(context) {
       ...
       */
      var allowShortCircuit, allowTaggedTemplates, allowTernary, config, directives, isDirective, isValidExpression, looksLikeDirective, takeWhile;
      ...
      isValidExpression = function(node) {
        ...
        return /^(?:Assignment|Call|New|Update|Yield|Await)Expression$/.test(node.type) || (node.type === 'UnaryExpression' && ['delete', 'void', 'do'].indexOf(node.operator) >= 0);
      };
      return {
