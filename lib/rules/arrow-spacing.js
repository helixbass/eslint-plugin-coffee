  ...
  module.exports = {
    ...
    create: function(context) {
      ...
      getTokens = function(node) {
        var arrow, firstBodyToken, ref;
        // AST currently includes arrow in body, so check there first
        firstBodyToken = (ref = sourceCode.getTokens(node.body)) != null ? ref[0] : void 0;
        arrow = isArrowToken(firstBodyToken) ? firstBodyToken : sourceCode.getTokenBefore(node.body, isArrowToken);
        return {
