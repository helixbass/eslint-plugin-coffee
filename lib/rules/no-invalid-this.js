...
(function() {
  ...
  module.exports = {
    ...
    create: function(context) {
       ...
       * @returns {void}
       */
      var enterFunction, exitFunction, fatArrowsOk, ref, sourceCode, stack;
      stack = [];
      ...
      stack.getCurrent = function() {
        ...
        if (!current.init) {
          current.init = true;
          current.valid = fatArrowsOk && current.node.bound ? true : !isDefaultThisBinding(current.node, sourceCode);
        }
        return current;
      };
      enterFunction = function(node) {
        if (node.bound && !fatArrowsOk) {
          return;
        }
