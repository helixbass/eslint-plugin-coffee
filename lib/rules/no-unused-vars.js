...
(function() {
  ...
  module.exports = {
    ...
    create: function(context) {
       ...
       * @private
       */
      var REST_PROPERTY_TYPE, STATEMENT_TYPE, collectUnusedVariables, config, firstOption, getAssignedMessage, getDefinedMessage, getRhsNode, hasRestSpreadSibling, isAfterLastUsedArg, isClassExpression, isExported, isForInRef, isIife, isInside, isInsideOfStorableFunction, isReadForItself, isReadRef, isSelfReference, isStorableFunction, isUsedVariable, sourceCode;
      ...
      collectUnusedVariables = function(scope, unusedVars) {
        ...
        if (scope.type !== 'TDZ' && (scope.type !== 'global' || config.vars === 'all')) {
          for (i = 0, len = variables.length; i < len; i++) {
            ...
            if (!isUsedVariable(variable) && !isExported(variable) && !isClassExpression(variable) && !hasRestSpreadSibling(variable)) {
