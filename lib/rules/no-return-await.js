...
(function() {
  ...
  module.exports = {
    ...
    create: function(context) {
       ...
       * @returns {void}
       */
      var hasErrorHandler, implicit, isInTailCallPosition, ref, reportUnnecessaryAwait;
      ({implicit = true} = (ref = context.options[0]) != null ? ref : {});
      reportUnnecessaryAwait = function(node) {
      ...
      isInTailCallPosition = function(node) {
        if (node.returns && implicit) {
          return true;
        }
      ...
      return {
        AwaitExpression: function(node) {
          if (isInTailCallPosition(node) && !hasErrorHandler(node)) {
            return reportUnnecessaryAwait(node);
          }
        }
      };
    }
