...
ruleTester.run 'forbid-elements', rule,
  ...
  ,
    ...
    options: [forbid: ['dotted.component']]
    errors: [message: '<dotted.component> is forbidden']
  ,
    code: '<dotted.Component />'
    options: [forbid: [element: 'dotted.Component', message: "that ain't cool"]]
    errors: [message: "<dotted.Component> is forbidden, that ain't cool"]
  ,
    code: '<button />'
    options: [forbid: [element: 'button', message: 'use <Button> instead']]
  ...
  ,
    ...
    errors: [message: '<_comp> is forbidden']
  ,
    code: 'React.createElement("button")'
    options: [forbid: [element: 'button', message: 'use <Button> instead']]
    errors: [message: '<button> is forbidden, use <Button> instead']
