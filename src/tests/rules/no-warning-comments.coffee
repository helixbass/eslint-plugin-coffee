...
rule = loadInternalEslintModule 'lib/rules/no-warning-comments'
...
ruleTester.run 'no-warning-comments', rule,
  ...
  ,
    code: '# any fixme'
    options: [location: 'anywhere']
    errors: [message: "Unexpected 'fixme' comment."]
  ,
    code: '# any fixme'
  ...
  ,
    ...
    errors: [message: "Unexpected '[litera|$]' comment."]
  ,
    code: '### eslint one-var: 2 ###'
    options: [terms: ['eslint']]
    errors: [message: "Unexpected 'eslint' comment."]
  ,
    code: '### eslint one-var: 2 ###'
    options: [terms: ['one'], location: 'anywhere']
    errors: [message: "Unexpected 'one' comment."]
  ,
    code: '### any block comment with TODO, FIXME or XXX ###'
    options: [location: 'anywhere']
    errors: [
