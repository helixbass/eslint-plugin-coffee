...
ruleTester.run 'named', rule,
  valid: [
    ...
    test code: 'import bar from "./bar.coffee"'
    test code: 'import bar, { foo } from "./bar.coffee"'
    ...
    test
      ...
      settings: 'import/resolve': extensions: ['.coffee']
    ...
    test code: '###jsnext### import { createStore } from "redux"'
    ...
    test code: 'import { common } from "./re-export-default"'
...
unless CASE_SENSITIVE_FS
  ruleTester.run 'named (path case-insensitivity)', rule,
    valid: [test code: 'import { b } from "./Named-Exports"']
    invalid: [
      test
...
ruleTester.run 'named (export *)', rule,
  valid: [test code: 'import { foo } from "./export-all"']
  invalid: [
    test
