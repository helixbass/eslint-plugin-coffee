...
ruleTester.run 'no-unknown-property', rule,
  ...
  ,
    ...
    errors: [
      message: "Unknown property 'http-equiv' found, use 'httpEquiv' instead"
    ]
  ,
    code: '<div accesskey="bar"></div>'
    output: '<div accessKey="bar"></div>'
    errors: [
      message: "Unknown property 'accesskey' found, use 'accessKey' instead"
    ]
  ,
  ...
  ,
    ...
    errors: [
      message: "Unknown property 'onmousedown' found, use 'onMouseDown' instead"
    ]
  ,
    # ,
    ...
    #   errors: [
    #     message: "Unknown property 'xlink:href' found, use 'xlinkHref' instead"
    #   ]
    code: '<rect clip-path="bar" />'
    output: '<rect clipPath="bar" />'
    errors: [
      message: "Unknown property 'clip-path' found, use 'clipPath' instead"
    ]
  ,
    code: '<script crossorigin />'
    errors: [
      message: "Unknown property 'crossorigin' found, use 'crossOrigin' instead"
    ]
  ,
  ...
  ,
    ...
    errors: [
      message:
        "Invalid property 'crossOrigin' found on tag 'div', but it is only allowed on: script, img, video, audio, link"
    ]
  ]
