...
rule = require '../../rules/capitalized-comments'
...
ruleTester.run 'capitalized-comments', rule,
  ...
  ,
    ...
    code: 'foo(### ignored ### a)'
    options: ['always', {ignoreInlineComments: yes}]
  ,
    code: 'foo(### Ignored ### a)'
    options: ['never', {ignoreInlineComments: yes}]
  ,
  ...
  ,
    ...
    options: ['always', {ignoreConsecutiveComments: yes}]
  ,
    code: [
      '### This comment is valid since it is capitalized, ###'
      '### and this one is valid since it follows a valid one, ###'
  ...
  ,
    code: 'foo(### invalid ###a)'
    output: 'foo(### Invalid ###a)'
    options: ['always', {ignoreInlineComments: no}]
    errors: [
      messageId: 'unexpectedLowercaseComment'
      line: 1
      column: 5
  ...
  ,
    ...
    options: ['never', {ignoreConsecutiveComments: yes}]
    errors: [
      messageId: 'unexpectedUppercaseComment'
      line: 1
      column: 1
  ...
  ,
    ...
    options: ['always', {ignoreConsecutiveComments: no}]
    errors: [
      messageId: 'unexpectedLowercaseComment'
      line: 2
      column: 1
