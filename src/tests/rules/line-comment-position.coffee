...
rule = loadInternalEslintModule 'lib/rules/line-comment-position'
...
ruleTester.run 'line-comment-position', rule,
  ...
  ,
    code: '# jscs: disable\n1 + 1'
    options: [position: 'beside', applyDefaultIgnorePatterns: no]
    errors: [
  ...
  ,
    ...
    code: '# jscs: disable\n1 + 1'
    options: [position: 'beside', applyDefaultPatterns: no]
    errors: [
      message: 'Expected comment to be beside code.'
      type: 'Line'
      line: 1
