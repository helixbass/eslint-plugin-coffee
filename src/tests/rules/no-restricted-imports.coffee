...
rule = loadInternalEslintModule 'lib/rules/no-restricted-imports'
...
ruleTester.run 'no-restricted-imports', rule,
  ...
  ,
    ...
    errors: [
      message:
        "'foo' import is restricted from being used. Please import the default import of 'foo' from /bar/ instead."
      type: 'ImportDeclaration'
    ]
  ,
  ...
  ,
    ...
    errors: [
      message:
        "'foo' import is restricted from being used. Please import 'DisallowedObject' from /bar/ instead."
      type: 'ImportDeclaration'
    ]
  ,
  ...
  ,
    ...
    errors: [
      message:
        "'foo' import is restricted from being used. Please import 'DisallowedObject' and 'DisallowedObjectTwo' from /bar/ instead."
      type: 'ImportDeclaration'
    ]
  ,
    code:
